...
<body leftMargin=0 topMargin=0 marginwidth="0" marginheight="0" style="background-image: 
	url('${pageContext.request.contextPath}/images/login.jpg'); background-size:1913px 935px ; background-attachment: fixed ">
<div ALIGN="center">
<table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1">
	...
	<tr>
   <td  width="800" height="496"></td>
   <td class="login_msg" width="600" align="center">
